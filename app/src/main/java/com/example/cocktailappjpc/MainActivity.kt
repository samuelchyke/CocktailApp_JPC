...
import com.example.cocktailappjpc.ui.theme.CocktailAppJPCTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cocktailViewModel.cocktails.observe({ lifecycle }) { response ->
            when (response) {
...
//                    showProgressBar()
        ...
        cocktailViewModel.searchCocktails("A")
